...
const styles = StyleSheet.create({
  ...
  accept: { backgroundColor: "#b9553c", borderRadius: 8, paddingHorizontal: 14, paddingVertical: 6 },
  ...
  recAccept: { flex: 1, backgroundColor: "#b9553c", borderRadius: 10, paddingVertical: 9, alignItems: "center" },
