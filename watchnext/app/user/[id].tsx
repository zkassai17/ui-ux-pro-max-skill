...
const styles = StyleSheet.create({
  ...
  blendBtn: { backgroundColor: "#b9553c", borderRadius: 14, paddingVertical: 13, alignItems: "center", marginTop: 12 },
  ...
  btn: { flex: 1, backgroundColor: "#b9553c", borderRadius: 10, paddingVertical: 11, alignItems: "center" },
