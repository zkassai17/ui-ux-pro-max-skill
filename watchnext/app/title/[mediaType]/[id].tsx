...
const styles = StyleSheet.create({
  ...
  genres: { fontSize: 12, color: "#b9553c", marginTop: 8 },
  ...
  reviewSave: { alignSelf: "flex-start", backgroundColor: "#b9553c", borderRadius: 10, paddingVertical: 8, paddingHorizontal: 20, marginTop: 8 },
  ...
  statusBtn: { borderWidth: 1.5, borderColor: "#b9553c", borderRadius: 10, paddingVertical: 11, alignItems: "center" },
  statusBtnOn: { backgroundColor: "#b9553c" },
  statusBtnText: { fontSize: 14, color: "#b9553c", fontWeight: "600" },
  ...
  btn: { backgroundColor: "#b9553c", borderRadius: 10, paddingVertical: 12, paddingHorizontal: 20, marginTop: 24, alignSelf: "stretch", alignItems: "center" },
