...
const styles = StyleSheet.create({
  ...
  edit: { color: "#b9553c", fontWeight: "700", fontSize: 14 },
  editRow: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: 6 },
  at: { fontSize: 16, color: "#aaa", fontWeight: "700" },
  input: { flex: 1, fontSize: 16, fontWeight: "600", borderBottomWidth: 1.5, borderColor: "#b9553c", paddingVertical: 2, color: "#111" },
  save: { color: "#b9553c", fontWeight: "800", fontSize: 14 },
  ...
  copyHint: { fontSize: 13, color: "#b9553c", fontWeight: "700" },
  ...
  langPillOn: { backgroundColor: "#b9553c" },
  ...
  rowBtnText: { fontSize: 15, fontWeight: "600", color: "#b9553c" },
  chevron: { fontSize: 20, color: "#bbb" },
  proRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#f7f0ea", borderRadius: 14, padding: 16 },
  proRowText: { fontSize: 15, fontWeight: "800", color: "#b9553c" },
  proActive: { backgroundColor: "#f7f0ea", borderRadius: 14, padding: 16 },
  proActiveText: { fontSize: 15, fontWeight: "800", color: "#b9553c" },
  ...
  proTuneRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#f5ede7", borderRadius: 10, paddingHorizontal: 12, paddingVertical: 11, marginTop: 14 },
  proTuneText: { fontSize: 13, fontWeight: "800", color: "#b9553c" },
  ...
  levelOn: { backgroundColor: "#b9553c" },
