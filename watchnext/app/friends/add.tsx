...
const styles = StyleSheet.create({
  ...
  btn: { backgroundColor: "#b9553c", borderRadius: 10, paddingVertical: 11, alignItems: "center", marginTop: 10 },
  ...
  smallBtn: { backgroundColor: "#b9553c", borderRadius: 8, paddingHorizontal: 14, paddingVertical: 6 },
